...
camera {
  //location  <0,-.60,6.6>
  //location  <0,-.60,6.6+154000*pow((0.69-clock),2)>
  location  <0,-.60,6.6+1540000000*pow((0.69-clock),4)>
  right -4/3*x
  angle 45
  look_at   0
}
...
object {Jupiter rotate clock*W_Jup*y }

object {Io scale R_Io

// Transformacio observador-{Io}
